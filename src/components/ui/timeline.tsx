...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full bg-dark  font-sans md:px-10 dark:bg-black dark:bg-grid-white/[0.07]"
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10 flex flex-col items-center justify-center">
        <h2 className="text-lg md:text-4xl mb-4 text-black dark:text-white max-w-4xl text-center mt-10">
